    ...
    <div className="app">
      ...
      <div className="dashboard-header">
        ...
        <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
          {view === 'dashboard' && (
            <div style={{ display: 'flex', gap: 16, alignItems: 'center', opacity: 0.5, fontSize: 13, marginRight: 8 }}>
              <a href="http://localhost:8080" target="_blank" rel="noreferrer" style={{ color: 'var(--text-secondary)', textDecoration: 'none' }}>Airflow</a>
              <a href="https://dev281822.service-now.com" target="_blank" rel="noreferrer" style={{ color: 'var(--text-secondary)', textDecoration: 'none' }}>ServiceNow</a>
              <a href="https://personalinbox999.atlassian.net/wiki/spaces/MFS/pages" target="_blank" rel="noreferrer" style={{ color: 'var(--text-secondary)', textDecoration: 'none' }}>Confluence</a>
            </div>
          )}
          {view !== 'analyze' && (
